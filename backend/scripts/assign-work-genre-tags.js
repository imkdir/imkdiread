...
const genreTagsByWorkId = {
  ...
  outcast_of_the_islands: ["genre:adventure-fiction", "genre:colonial-fiction"],
  ...
  dracula: ["genre:gothic-fiction", "genre:horror", "genre:british-literature"],
  ...
  faust: ["genre:drama", "genre:german-literature", "genre:classic-literature"],
  flight_to_arras: [
    "genre:memoir",
    "genre:war-literature",
    "genre:french-literature",
  ...
  from_man_to_man: ["genre:south-african-literature", "genre:literary-fiction"],
  ...
  keepers_of_the_house: ["genre:southern-fiction", "genre:american-literature"],
